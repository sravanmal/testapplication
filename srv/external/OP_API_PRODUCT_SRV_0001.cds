/* checksum : c92609f2597e7ebe8dd33ff52c6eadc9 */
@cds.external : true
@m.IsDefaultEntityContainer : 'true'
@sap.supported.formats : 'atom json xlsx'
service OP_API_PRODUCT_SRV_0001 {};
...
@sap.label : 'Product'
entity OP_API_PRODUCT_SRV_0001.A_Product {
  ...
  to_Description : Association to many OP_API_PRODUCT_SRV_0001.A_ProductDescription {  };
  to_Plant : Association to many OP_API_PRODUCT_SRV_0001.A_ProductPlant {  };
  to_ProductBasicText : Association to many OP_API_PRODUCT_SRV_0001.A_ProductBasicText {  };
  to_ProductInspectionText : Association to many OP_API_PRODUCT_SRV_0001.A_ProductInspectionText {  };
  to_ProductProcurement : Association to OP_API_PRODUCT_SRV_0001.A_ProductProcurement {  };
  to_ProductPurchaseText : Association to many OP_API_PRODUCT_SRV_0001.A_ProductPurchaseText {  };
  to_ProductQualityMgmt : Association to OP_API_PRODUCT_SRV_0001.A_ProductQualityMgmt {  };
  to_ProductSales : Association to OP_API_PRODUCT_SRV_0001.A_ProductSales {  };
  to_ProductSalesTax : Association to many OP_API_PRODUCT_SRV_0001.A_ProductSalesTax {  };
  to_ProductStorage : Association to OP_API_PRODUCT_SRV_0001.A_ProductStorage {  };
  to_ProductUnitsOfMeasure : Association to many OP_API_PRODUCT_SRV_0001.A_ProductUnitsOfMeasure {  };
  to_SalesDelivery : Association to many OP_API_PRODUCT_SRV_0001.A_ProductSalesDelivery {  };
  to_Valuation : Association to many OP_API_PRODUCT_SRV_0001.A_ProductValuation {  };
};
...
entity OP_API_PRODUCT_SRV_0001.A_ProductBasicText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
...
entity OP_API_PRODUCT_SRV_0001.A_ProductDescription {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductInspectionText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductMLAccount {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductMLPrices {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductPlant {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
  ...
  to_PlantMRPArea : Association to many OP_API_PRODUCT_SRV_0001.A_ProductPlantMRPArea {  };
  to_PlantQualityMgmt : Association to OP_API_PRODUCT_SRV_0001.A_ProductPlantQualityMgmt {  };
  to_PlantSales : Association to OP_API_PRODUCT_SRV_0001.A_ProductPlantSales {  };
  to_PlantStorage : Association to OP_API_PRODUCT_SRV_0001.A_ProductPlantStorage {  };
  to_PlantText : Association to OP_API_PRODUCT_SRV_0001.A_ProductPlantText {  };
  to_ProdPlantInternationalTrade : Association to OP_API_PRODUCT_SRV_0001.A_ProductPlantIntlTrd {  };
  to_ProductPlantCosting : Association to OP_API_PRODUCT_SRV_0001.A_ProductPlantCosting {  };
  to_ProductPlantForecast : Association to OP_API_PRODUCT_SRV_0001.A_ProductPlantForecasting {  };
  to_ProductPlantProcurement : Association to OP_API_PRODUCT_SRV_0001.A_ProductPlantProcurement {  };
  to_ProductSupplyPlanning : Association to OP_API_PRODUCT_SRV_0001.A_ProductSupplyPlanning {  };
  to_ProductWorkScheduling : Association to OP_API_PRODUCT_SRV_0001.A_ProductWorkScheduling {  };
  to_StorageLocation : Association to many OP_API_PRODUCT_SRV_0001.A_ProductStorageLocation {  };
};
...
entity OP_API_PRODUCT_SRV_0001.A_ProductPlantCosting {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductPlantForecasting {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductPlantIntlTrd {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductPlantMRPArea {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductPlantProcurement {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductPlantQualityMgmt {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductPlantSales {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductPlantStorage {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductPlantText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductProcurement {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductPurchaseText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductQualityMgmt {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductSales {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductSalesDelivery {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
  ...
  to_SalesTax : Association to many OP_API_PRODUCT_SRV_0001.A_ProductSalesTax {  };
  to_SalesText : Association to many OP_API_PRODUCT_SRV_0001.A_ProductSalesText {  };
};
...
entity OP_API_PRODUCT_SRV_0001.A_ProductSalesTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductSalesText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductStorage {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductStorageLocation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductSupplyPlanning {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductUnitsOfMeasure {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
  ...
  @sap.semantics : 'unit-of-measure'
  BaseUnit : String(3);
  to_InternationalArticleNumber : Association to many OP_API_PRODUCT_SRV_0001.A_ProductUnitsOfMeasureEAN {  };
};
...
@sap.content.version : '1'
@sap.label : 'GTIN Data'
entity OP_API_PRODUCT_SRV_0001.A_ProductUnitsOfMeasureEAN {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductValuation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
  ...
  @sap.semantics : 'unit-of-measure'
  BaseUnit : String(3);
  to_MLAccount : Association to many OP_API_PRODUCT_SRV_0001.A_ProductMLAccount {  };
  to_MLPrices : Association to many OP_API_PRODUCT_SRV_0001.A_ProductMLPrices {  };
  to_ValuationAccount : Association to OP_API_PRODUCT_SRV_0001.A_ProductValuationAccount {  };
  to_ValuationCosting : Association to OP_API_PRODUCT_SRV_0001.A_ProductValuationCosting {  };
};
...
entity OP_API_PRODUCT_SRV_0001.A_ProductValuationAccount {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductValuationCosting {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity OP_API_PRODUCT_SRV_0001.A_ProductWorkScheduling {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
